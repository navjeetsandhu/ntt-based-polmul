...
def poly_demo():
    ...
    print(
        "SchoolbookModPolMul_PWC  --> " + ("Correct" if (sum([abs(x - y) for x, y in zip(DR0, C0)]) == 0) else "Wrong"))
    print(
        "SchoolbookModPolMul_NWC  --> " + ("Correct" if (sum([abs(x - y) for x, y in zip(DR1, C1)]) == 0) else "Wrong"))
    print(
        "SchoolbookModPolMul_NTRU --> " + ("Correct" if (sum([abs(x - y) for x, y in zip(DR2, C2)]) == 0) else "Wrong"))
    print("")
    ...
    print(
        "NTTBasedPolMul           --> " + ("Correct" if (sum([abs(x - y) for x, y in zip(N0, D0)]) == 0) else "Wrong"))
    print(
        "NTTBasedModPolMul_PWC    --> " + ("Correct" if (sum([abs(x - y) for x, y in zip(N1, C0)]) == 0) else "Wrong"))
    print(
        "NTTBasedModPolMul_NWC_v1 --> " + ("Correct" if (sum([abs(x - y) for x, y in zip(N2, C1)]) == 0) else "Wrong"))
    print(
        "NTTBasedModPolMul_NWC_v2 --> " + ("Correct" if (sum([abs(x - y) for x, y in zip(N3, C1)]) == 0) else "Wrong"))
    print("")
    ...
    T8 = Evaluator.CRTBasedModPolMul_NTRU_FDV(A_ntru, B_ntru, mw, mw_inv, ntrupowersf, ntrupowersb, ntrupowersi, mq,
                                              findeg=3)
    T9 = Evaluator.CRTBasedModPolMul_NTRU_FDV(A_ntru, B_ntru, mw, mw_inv, ntrupowersf, ntrupowersb, ntrupowersi, mq,
                                              findeg=6)
    T10 = Evaluator.CRTBasedModPolMul_NTRU_FDV(A_ntru, B_ntru, mw, mw_inv, ntrupowersf, ntrupowersb, ntrupowersi, mq,
                                               findeg=12)
    T11 = Evaluator.CRTBasedModPolMul_NTRU_FDV(A_ntru, B_ntru, mw, mw_inv, ntrupowersf, ntrupowersb, ntrupowersi, mq,
                                               findeg=24)
    ...
    print("CRTBasedModPolMul_PWC                  --> " + (
        "Correct" if (sum([abs(x - y) for x, y in zip(T0, C0)]) == 0) else "Wrong"))
    print("CRTBasedModPolMul_NWC_FD1              --> " + (
        "Correct" if (sum([abs(x - y) for x, y in zip(T1, C1)]) == 0) else "Wrong"))
    print("CRTBasedModPolMul_NWC_FD2              --> " + (
        "Correct" if (sum([abs(x - y) for x, y in zip(T2, C1)]) == 0) else "Wrong"))
    print("CRTBasedModPolMul_NWC_FDV  (findeg=1)  --> " + (
        "Correct" if (sum([abs(x - y) for x, y in zip(T3, C1)]) == 0) else "Wrong"))
    print("CRTBasedModPolMul_NWC_FDV  (findeg=2)  --> " + (
        "Correct" if (sum([abs(x - y) for x, y in zip(T4, C1)]) == 0) else "Wrong"))
    print("CRTBasedModPolMul_NWC_FDV  (findeg=4)  --> " + (
        "Correct" if (sum([abs(x - y) for x, y in zip(T5, C1)]) == 0) else "Wrong"))
    print("CRTBasedModPolMul_NWC_FDV  (findeg=8)  --> " + (
        "Correct" if (sum([abs(x - y) for x, y in zip(T6, C1)]) == 0) else "Wrong"))
    print("CRTBasedModPolMul_NTRU_FD3             --> " + (
        "Correct" if (sum([abs(x - y) for x, y in zip(T7, C2)]) == 0) else "Wrong"))
    print("CRTBasedModPolMul_NTRU_FDV (findeg=3)  --> " + (
        "Correct" if (sum([abs(x - y) for x, y in zip(T8, C2)]) == 0) else "Wrong"))
    print("CRTBasedModPolMul_NTRU_FDV (findeg=6)  --> " + (
        "Correct" if (sum([abs(x - y) for x, y in zip(T9, C2)]) == 0) else "Wrong"))
    print("CRTBasedModPolMul_NTRU_FDV (findeg=12) --> " + (
        "Correct" if (sum([abs(x - y) for x, y in zip(T10, C2)]) == 0) else "Wrong"))
    print("CRTBasedModPolMul_NTRU_FDV (findeg=24) --> " + (
        "Correct" if (sum([abs(x - y) for x, y in zip(T11, C2)]) == 0) else "Wrong"))
    print("")
    ...
    ring, findeg = 1, 3
    R3 = Evaluator.CRTBasedModPolMul_Unified(A_ntru, B_ntru, mw, mw_inv, mq, ring, findeg, ntrupowersf, ntrupowersb,
                                             ntrupowersi)  # NTRU - findeg=3
    ring, findeg = 1, 6
    R4 = Evaluator.CRTBasedModPolMul_Unified(A_ntru, B_ntru, mw, mw_inv, mq, ring, findeg, ntrupowersf, ntrupowersb,
                                             ntrupowersi)  # NTRU - findeg=6
    ring, findeg = 1, 12
    R5 = Evaluator.CRTBasedModPolMul_Unified(A_ntru, B_ntru, mw, mw_inv, mq, ring, findeg, ntrupowersf, ntrupowersb,
                                             ntrupowersi)  # NTRU - findeg=12

    print("CRTBasedModPolMul_Unified (NWC  - findeg=1)  --> " + (
        "Correct" if (sum([abs(x - y) for x, y in zip(R0, C1)]) == 0) else "Wrong"))
    print("CRTBasedModPolMul_Unified (NWC  - findeg=2)  --> " + (
        "Correct" if (sum([abs(x - y) for x, y in zip(R1, C1)]) == 0) else "Wrong"))
    print("CRTBasedModPolMul_Unified (NWC  - findeg=4)  --> " + (
        "Correct" if (sum([abs(x - y) for x, y in zip(R2, C1)]) == 0) else "Wrong"))
    print("CRTBasedModPolMul_Unified (NTRU - findeg=3)  --> " + (
        "Correct" if (sum([abs(x - y) for x, y in zip(R3, C2)]) == 0) else "Wrong"))
    print("CRTBasedModPolMul_Unified (NTRU - findeg=6)  --> " + (
        "Correct" if (sum([abs(x - y) for x, y in zip(R4, C2)]) == 0) else "Wrong"))
    print("CRTBasedModPolMul_Unified (NTRU - findeg=12) --> " + (
        "Correct" if (sum([abs(x - y) for x, y in zip(R5, C2)]) == 0) else "Wrong"))
